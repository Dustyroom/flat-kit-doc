...
This is an appropriate time to talk about [Height Gradient](/stylized-surface/#height-gradient) parameter Flat Kit offers. You can use it as a part of Stylized Surface, Stylized Surface Cutout and Terrain shaders. Height Gradient works wonders on terrain in context of flat shading.
