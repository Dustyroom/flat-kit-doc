...
* **Use Distance Fog On Sky**[^1]  - whether to use distance fog on the skybox or not. If unchecked, the distance fog is not applied to the sky.
...
* **Use Height Fog On Sky**[^1] - whether to use height fog on the skybox or not. If unchecked, the height fog is not applied to the sky.

[^1]: **Use Distance/Height Fog On Sky** parameters are discontinued and appear in legacy pre-2022.3 Unity versions only. 
{:.notice--warning}
