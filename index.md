...
> **A.** Flat Kit is compatible with Unity minimum version of 2020.3.37f1, 2021.3.5f1 or 2022.1.10f1, the minimum minor versions for all major versions are listed on the [Flat Kit's Asset Store](https://assetstore.unity.com/packages/vfx/shaders/flat-kit-toon-shading-and-water-143368) page, under 'Render pipeline compatibility' paragraph.
...
- **Step 1.** It's advised that you imported Flat Kit from Unity Package Manager. Please, make sure you have Unity v. 2020.3.37f1, 2021.3.5f1 or 2022.1.10f1 or later running. Go to Window ▶︎ Package Manager. On the top left find the My Assets drop down menu. You'll find Flat Kit among your assets. Choose the version you'd like to import. Click Download, then Import.  
...
- _Depth Fade Distance_ controls how quickly the **objects behind light plane** become hidden. Imagine you are looking at a frosted glass window. Any objects that are very close to the window on the other side are clearly visible, but anything that's far behind the window is completely blurred out. _Depth Fade Distance_ defines how far the objects need to be from the window to become completely invisible.

- _Camera Distance Fade Close_ / _Camera Distance Fade Far_ control distance range from the camera at which **the light plane object** transitions from transparent to opaque (see pic below).
